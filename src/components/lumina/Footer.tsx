...
export default function Footer() {
  ...
  return (
    <footer
      ...
      style={{
        background: "linear-gradient(160deg, #0a0a0a 0%, #111111 40%, #171717 100%)",
      }}
    >
      {/* Top accent line */}
      <div className="absolute top-0 start-0 end-0 h-px bg-gradient-to-r from-transparent via-rose-500/30 to-transparent" />
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-10 py-16 lg:py-20">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          <div>
            <a href="#" onClick={(e) => { e.preventDefault(); window.scrollTo({ top: 0, behavior: "smooth" }); }} className="flex items-center gap-2.5 mb-5">
              ...
              <div className="flex flex-col leading-none">
                ...
                <span className="font-display font-light text-[10px] text-rose-400 tracking-[0.15em] uppercase mt-0.5">
                  {t("footer.logo_sub")}
                </span>
              </div>
            </a>
            ...
            <div className="flex gap-2.5">
              {[
                ...
                <a
                  ...
                  href="#"
                  aria-label={label}
                  className="w-9 h-9 rounded-lg bg-white/5 hover:bg-rose-500 flex items-center justify-center transition-all duration-300 hover:scale-110"
                >
          ...
          <div>
            <h4 className="font-semibold text-[11px] uppercase tracking-[0.15em] text-white/40 mb-5">
              {t("footer.col_links")}
            </h4>
              ...
              {quickLinks.map((link) => (
                <li key={link.href}>
                  <button
                    ...
                    className="text-white/30 text-sm hover:text-rose-400 transition-colors"
                  >
                    {link.label}
                  </button>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+1234567890" className="text-white/30 text-sm hover:text-rose-400 transition-colors">
                  (123) 456-7890
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="w-4 h-4 text-rose-500 shrink-0" />
                <a href="mailto:hello@luminadental.com" className="text-white/30 text-sm hover:text-rose-400 transition-colors">
          ...
          <div>
            ...
            <div className="mt-5 inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-rose-500/10 border border-rose-500/15">
              <PhoneCall className="w-3 h-3 text-rose-400" />
              <span className="text-[11px] text-rose-300 font-semibold">{t("footer.emergency")}</span>
            </div>
          </div>
        </div>
